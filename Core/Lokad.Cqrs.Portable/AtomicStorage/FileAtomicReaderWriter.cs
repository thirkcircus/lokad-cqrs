...
{
    public sealed class FileAtomicReaderWriter<TKey, TEntity> : IAtomicReader<TKey, TEntity>,
                                                             IAtomicWriter<TKey, TEntity>
    {
        readonly IAtomicStorageStrategy _strategy;
        readonly string _folder;

        public FileAtomicReaderWriter(string directoryPath, IAtomicStorageStrategy strategy)
        {
            _strategy = strategy;
